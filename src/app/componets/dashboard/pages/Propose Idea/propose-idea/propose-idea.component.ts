...
export class ProposeIdeaComponent implements OnInit {
  ...
  isIdeaOverlayOpen: boolean = false;
  ...
  ngOnInit(): void {
   ...
   this.loadideas();
    ...
    this.ideaSaveForm = this.fb.group({
      title: ['', Validators.required],
      description: ['', Validators.required],
      descriptionSituation: [''],  // Removed Validators.required
      descriptionSolution: [''],  // Removed Validators.required
      name_Area: ['', Validators.required],
      project_Name: ['', Validators.required],
      name_Machine: ['', Validators.required],
      userId: this.Id,
      fileSituationPath: [this.FileSituation],  // Removed Validators.required
      fileSolutionPath: [this.FileSolution],  // Removed Validators.required
...
toggleDropdown() {
  this.isIdeaOverlayOpen = !this.isIdeaOverlayOpen;
}
toggleDropdownList(){
